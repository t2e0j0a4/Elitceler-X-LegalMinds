      ...
      <section className={consult__section1}>
        <div className={section1__center}>
          ...
          <p>
            {service
              ? serviceInfo
              : "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sint voluptatem facilis ex quaerat obcaecati quisquam unde ut ipsum debitis culpa eos fugiat aliquid nemo veritatis, quae magnam, veniam natus. Id."}
          </p>
        </div>
      </section>
